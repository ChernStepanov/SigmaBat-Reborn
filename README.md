...
Проект предоставляется в образовательных и исследовательских целях. Используйте его только на тех системах и в тех средах, где у вас есть разрешение на тестирование. Идея репозитория заключается в демонстрации возможности расширения функционала служебных скриптов, автор не несёт ответственности за ваши действия.
